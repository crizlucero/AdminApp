...
namespace Org.Apache.Commons.Codec.Binary {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.apache.commons.codec.binary']/class[@name='Base64OutputStream']"
	[global::Android.Runtime.Register ("org/apache/commons/codec/binary/Base64OutputStream", DoNotGenerateAcw=true)]
	public partial class Base64OutputStream : global::Org.Apache.Commons.Codec.Binary.BaseNCodecOutputStream {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/apache/commons/codec/binary/Base64OutputStream", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.codec.binary']/class[@name='Base64OutputStream']/constructor[@name='Base64OutputStream' and count(parameter)=1 and parameter[1][@type='java.io.OutputStream']]"
		[Register (".ctor", "(Ljava/io/OutputStream;)V", "")]
		public unsafe Base64OutputStream (global::System.IO.Stream @out)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (Base64OutputStream)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.codec.binary']/class[@name='Base64OutputStream']/constructor[@name='Base64OutputStream' and count(parameter)=2 and parameter[1][@type='java.io.OutputStream'] and parameter[2][@type='boolean']]"
		[Register (".ctor", "(Ljava/io/OutputStream;Z)V", "")]
		public unsafe Base64OutputStream (global::System.IO.Stream @out, bool doEncode)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.codec.binary']/class[@name='Base64OutputStream']/constructor[@name='Base64OutputStream' and count(parameter)=4 and parameter[1][@type='java.io.OutputStream'] and parameter[2][@type='boolean'] and parameter[3][@type='int'] and parameter[4][@type='byte[]']]"
		[Register (".ctor", "(Ljava/io/OutputStream;ZI[B)V", "")]
		public unsafe Base64OutputStream (global::System.IO.Stream @out, bool doEncode, int lineLength, byte[] lineSeparator)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
