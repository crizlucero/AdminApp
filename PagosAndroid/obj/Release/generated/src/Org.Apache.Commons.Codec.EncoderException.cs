...
namespace Org.Apache.Commons.Codec {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.apache.commons.codec']/class[@name='EncoderException']"
	[global::Android.Runtime.Register ("org/apache/commons/codec/EncoderException", DoNotGenerateAcw=true)]
	public partial class EncoderException : global::Java.Lang.Exception {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/apache/commons/codec/EncoderException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (EncoderException); }
		}

		protected EncoderException (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.codec']/class[@name='EncoderException']/constructor[@name='EncoderException' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe EncoderException ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (EncoderException)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.codec']/class[@name='EncoderException']/constructor[@name='EncoderException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe EncoderException (string message)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.codec']/class[@name='EncoderException']/constructor[@name='EncoderException' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public unsafe EncoderException (string message, global::Java.Lang.Throwable cause)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.codec']/class[@name='EncoderException']/constructor[@name='EncoderException' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/Throwable;)V", "")]
		public unsafe EncoderException (global::Java.Lang.Throwable cause)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
