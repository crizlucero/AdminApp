...
namespace Org.Apache.Commons.Codec.Language {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.apache.commons.codec.language']/class[@name='Caverphone2']"
	[global::Android.Runtime.Register ("org/apache/commons/codec/language/Caverphone2", DoNotGenerateAcw=true)]
	public partial class Caverphone2 : global::Org.Apache.Commons.Codec.Language.AbstractCaverphone {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/apache/commons/codec/language/Caverphone2", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.codec.language']/class[@name='Caverphone2']/constructor[@name='Caverphone2' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Caverphone2 ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (Caverphone2)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Org.Apache.Commons.Codec.Language.Caverphone2 __this = global::Java.Lang.Object.GetObject<global::Org.Apache.Commons.Codec.Language.Caverphone2> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.apache.commons.codec.language']/class[@name='Caverphone2']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("encode", "(Ljava/lang/String;)Ljava/lang/String;", "GetEncode_Ljava_lang_String_Handler")]
		public override unsafe string Encode (string source)
		{
