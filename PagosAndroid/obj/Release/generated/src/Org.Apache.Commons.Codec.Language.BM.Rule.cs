	...
	public partial class Rule : global::Java.Lang.Object {
		...
		public partial interface IPhonemeExpr : IJavaObject {
			...
			global::Java.Lang.IIterable Phonemes {
				...
				[Register ("getPhonemes", "()Ljava/lang/Iterable;", "GetGetPhonemesHandler:Org.Apache.Commons.Codec.Language.BM.Rule/IPhonemeExprInvoker, PagosAndroid")] get;
			}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='org.apache.commons.codec.language.bm']/class[@name='Rule.PhonemeList']"
		[global::Android.Runtime.Register ("org/apache/commons/codec/language/bm/Rule$PhonemeList", DoNotGenerateAcw=true)]
		public sealed partial class PhonemeList : global::Java.Lang.Object, global::Org.Apache.Commons.Codec.Language.BM.Rule.IPhonemeExpr {

			internal static new IntPtr java_class_handle;
			internal static new IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("org/apache/commons/codec/language/bm/Rule$PhonemeList", ref java_class_handle);
				}
			}
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (PhonemeList); }
			}

			internal PhonemeList (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

			static IntPtr id_ctor_Ljava_util_List_;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='org.apache.commons.codec.language.bm']/class[@name='Rule.PhonemeList']/constructor[@name='Rule.PhonemeList' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;org.apache.commons.codec.language.bm.Rule.Phoneme&gt;']]"
			[Register (".ctor", "(Ljava/util/List;)V", "")]
			public unsafe PhonemeList (global::System.Collections.Generic.IList<global::Org.Apache.Commons.Codec.Language.BM.Rule.Phoneme> phonemes)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;

				IntPtr native_phonemes = global::Android.Runtime.JavaList<global::Org.Apache.Commons.Codec.Language.BM.Rule.Phoneme>.ToLocalJniHandle (phonemes);
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (native_phonemes);
					if (((object) this).GetType () != typeof (PhonemeList)) {
						SetHandle (
					...
					JNIEnv.DeleteLocalRef (native_phonemes);
				}
			}

			static IntPtr id_getPhonemes;
			public unsafe global::System.Collections.Generic.IList<global::Org.Apache.Commons.Codec.Language.BM.Rule.Phoneme> Phonemes {
				// Metadata.xml XPath method reference: path="/api/package[@name='org.apache.commons.codec.language.bm']/class[@name='Rule.PhonemeList']/method[@name='getPhonemes' and count(parameter)=0]"
				[Register ("getPhonemes", "()Ljava/util/List;", "GetGetPhonemesHandler")]
				get {
					if (id_getPhonemes == IntPtr.Zero)
						id_getPhonemes = JNIEnv.GetMethodID (class_ref, "getPhonemes", "()Ljava/util/List;");
					try {
						return global::Android.Runtime.JavaList<global::Org.Apache.Commons.Codec.Language.BM.Rule.Phoneme>.FromJniHandle (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getPhonemes), JniHandleOwnership.TransferLocalRef);
					} finally {
					}
				}
			}
		...
		public partial interface IRPattern : IJavaObject {
			...
			[Register ("isMatch", "(Ljava/lang/CharSequence;)Z", "GetIsMatch_Ljava_lang_CharSequence_Handler:Org.Apache.Commons.Codec.Language.BM.Rule/IRPatternInvoker, PagosAndroid")]
