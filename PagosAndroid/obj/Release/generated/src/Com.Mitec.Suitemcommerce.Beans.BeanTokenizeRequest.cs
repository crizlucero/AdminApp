...
namespace Com.Mitec.Suitemcommerce.Beans {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']"
	[global::Android.Runtime.Register ("com/mitec/suitemcommerce/beans/BeanTokenizeRequest", DoNotGenerateAcw=true)]
	public partial class BeanTokenizeRequest : global::Java.Lang.Object {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/mitec/suitemcommerce/beans/BeanTokenizeRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BeanTokenizeRequest); }
		}

		protected BeanTokenizeRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']/constructor[@name='BeanTokenizeRequest' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe BeanTokenizeRequest (string response)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (BeanTokenizeRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Mitec.Suitemcommerce.Beans.BeanTokenizeRequest __this = global::Java.Lang.Object.GetObject<global::Com.Mitec.Suitemcommerce.Beans.BeanTokenizeRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string CdError {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']/method[@name='getCdError' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']/method[@name='setCdError' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string NbError {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']/method[@name='getNbError' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']/method[@name='setNbError' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string NbResponse {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']/method[@name='getNbResponse' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']/method[@name='setNbResponse' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Response {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']/method[@name='getResponse' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mitec.suitemcommerce.beans']/class[@name='BeanTokenizeRequest']/method[@name='setResponse' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
