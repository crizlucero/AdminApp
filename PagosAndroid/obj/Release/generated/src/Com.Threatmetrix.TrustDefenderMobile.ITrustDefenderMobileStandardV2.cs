...
namespace Com.Threatmetrix.TrustDefenderMobile {
	...
	public partial interface ITrustDefenderMobileStandardV2 : IJavaObject {
		...
		global::Com.Threatmetrix.TrustDefenderMobile.ProfilingResult Result {
			...
			[Register ("getResult", "()Lcom/threatmetrix/TrustDefenderMobile/ProfilingResult;", "GetGetResultHandler:Com.Threatmetrix.TrustDefenderMobile.ITrustDefenderMobileStandardV2Invoker, PagosAndroid")] get;
		}
		...
		[Register ("cancel", "()V", "GetCancelHandler:Com.Threatmetrix.TrustDefenderMobile.ITrustDefenderMobileStandardV2Invoker, PagosAndroid")]
		void Cancel ();
		...
		[Register ("doPackageScan", "(I)Z", "GetDoPackageScan_IHandler:Com.Threatmetrix.TrustDefenderMobile.ITrustDefenderMobileStandardV2Invoker, PagosAndroid")]
		...
		[Register ("doProfileRequest", "()Lcom/threatmetrix/TrustDefenderMobile/THMStatusCode;", "GetDoProfileRequestHandler:Com.Threatmetrix.TrustDefenderMobile.ITrustDefenderMobileStandardV2Invoker, PagosAndroid")]
		...
		[Register ("doProfileRequest", "(Ljava/lang/String;)Lcom/threatmetrix/TrustDefenderMobile/THMStatusCode;", "GetDoProfileRequest_Ljava_lang_String_Handler:Com.Threatmetrix.TrustDefenderMobile.ITrustDefenderMobileStandardV2Invoker, PagosAndroid")]
		...
		[Register ("init", "(Landroid/content/Context;)V", "GetInit_Landroid_content_Context_Handler:Com.Threatmetrix.TrustDefenderMobile.ITrustDefenderMobileStandardV2Invoker, PagosAndroid")]
		...
		[Register ("init", "(Lcom/threatmetrix/TrustDefenderMobile/Config;)V", "GetInit_Lcom_threatmetrix_TrustDefenderMobile_Config_Handler:Com.Threatmetrix.TrustDefenderMobile.ITrustDefenderMobileStandardV2Invoker, PagosAndroid")]
		...
		[Register ("pauseLocationServices", "(Z)V", "GetPauseLocationServices_ZHandler:Com.Threatmetrix.TrustDefenderMobile.ITrustDefenderMobileStandardV2Invoker, PagosAndroid")]
		...
		[Register ("tidyUp", "()V", "GetTidyUpHandler:Com.Threatmetrix.TrustDefenderMobile.ITrustDefenderMobileStandardV2Invoker, PagosAndroid")]
		void TidyUp ();
