...
void xamarin_create_classes () {
	...
	__xamarin_class_map [251].handle = objc_getClass ("__UIGestureRecognizerParametrizedToken");
	...
	__xamarin_class_map [257].handle = objc_getClass ("UIKit_UIAlertView__UIAlertViewDelegate");
	__xamarin_class_map [258].handle = objc_getClass ("UIKit_UIControl_UIControlAppearance");
	__xamarin_class_map [259].handle = objc_getClass ("UIKit_UIBarButtonItem_Callback");
	__xamarin_class_map [260].handle = objc_getClass ("__UIRotationGestureRecognizer");
	__xamarin_class_map [261].handle = objc_getClass ("__UITapGestureRecognizer");
	__xamarin_class_map [262].handle = objc_getClass ("__UIPinchGestureRecognizer");
	__xamarin_class_map [263].handle = objc_getClass ("__UISwipeGestureRecognizer");
	__xamarin_class_map [264].handle = objc_getClass ("__UIScreenEdgePanGestureRecognizer");
