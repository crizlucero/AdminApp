...
@interface ReservarSalaJuntasViewTableController : UITableViewController {
	...
	@property (nonatomic, assign) UILabel * lblCapacidad;
	@property (nonatomic, assign) UILabel * lblCreditosDisponibles;
	@property (nonatomic, assign) UILabel * lblCreditosPorUsar;
	@property (nonatomic, assign) UILabel * lblDiaLetra;
	@property (nonatomic, assign) UILabel * lblDiaNumero;
	@property (nonatomic, assign) UILabel * lblHorasReservadas;
	@property (nonatomic, assign) UILabel * lblNombre;
	@property (nonatomic, assign) UILabel * lblPiso;
	...
	@property (nonatomic, assign) UIView * view2324;
	@property (nonatomic, assign) UIView * vw0102;
	@property (nonatomic, assign) UIView * vw0203;
	@property (nonatomic, assign) UIView * vw0304;
	@property (nonatomic, assign) UIView * vw0405;
	@property (nonatomic, assign) UIView * vw0506;
	@property (nonatomic, assign) UIView * vw0607;
	@property (nonatomic, assign) UIView * vw0708;
	@property (nonatomic, assign) UIView * vw0809;
	@property (nonatomic, assign) UIView * vw0910;
	@property (nonatomic, assign) UIView * vw1011;
	@property (nonatomic, assign) UIView * vw1112;
	@property (nonatomic, assign) UIView * vw1213;
	@property (nonatomic, assign) UIView * vw1314;
	@property (nonatomic, assign) UIView * vw1415;
	@property (nonatomic, assign) UIView * vw1516;
	@property (nonatomic, assign) UIView * vw1617;
	@property (nonatomic, assign) UIView * vw1718;
	@property (nonatomic, assign) UIView * vw1819;
	@property (nonatomic, assign) UIView * vw1920;
	@property (nonatomic, assign) UIView * vw2021;
	@property (nonatomic, assign) UIView * vw2122;
	@property (nonatomic, assign) UIView * vw2223;
	@property (nonatomic, assign) UIView * vw2401;
