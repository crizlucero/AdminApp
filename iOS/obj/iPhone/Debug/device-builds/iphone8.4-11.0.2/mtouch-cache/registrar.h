...
@interface TableViewController : UITableViewController {
	...
	@property (nonatomic, assign) UITableViewCell * cllDashboard;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
...
@interface ComentariosHeaderCell : UITableViewCell {
}
...
@interface LoginViewController : UIViewController {
	...
	@property (nonatomic, assign) UIButton * NotNowButton;
...
@interface ProductosController : UIViewController {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
