...
namespace WorklabsMx.iOS
{
    public partial class MiMembresiaController : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            Add(lblMembresias);
            foreach (MembresiaModel membresia in new SuscripcionesController().GetMembresiasContratadas(KeyChainHelper.GetKey("Usuario_Id")))
            {
            ...
            Add(lblProductos);
            #endregion
            foreach (ProductoModel producto in new SuscripcionesController().GetProductosContratados(KeyChainHelper.GetKey("Usuario_Id")))
            {
