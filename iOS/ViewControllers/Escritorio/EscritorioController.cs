...
         List<PostModel> allPosts = new List<PostModel>();          List<UIImage> allProfileImages = new List<UIImage>();         List<UIImage> allPostImages = new List<UIImage>();         List<string> miembro;          UsuarioModel ListUser = new UsuarioModel();          PostModel CurrentPost = new PostModel();         UIImage currentProfileImage = new UIImage();         UIImage currentPostImage = new UIImage();         UIImageView ImagenPerfil;          string upload_image_path;          public List<ItemsMenu> tableItems = new List<ItemsMenu>();          float withImage; 
        ...
        {             base.ViewWillAppear(animated);             await CargarInfo();             TableView.ReloadData();             this.TableView.BeginUpdates();             this.TableView.EndUpdates();             BTProgressHUD.Dismiss();
