    ...
    public class PickerItemsController : DataBaseModel
    {
        ...
        public List<string> GetGeneros()
        {
            ...
            catch (Exception e)
            {
                ...
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetGeneros");
            }
            finally
            {
                conn.Close();
        ...
        public List<string> GetMunicipios(string estado)
        {
            ...
            {
                Console.WriteLine(e.Message);
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetMunicipios");
            }
            finally
            {
                conn.Close();
        ...
        public int GetGiroId(string giro)
        {
            ...
            {
                Console.WriteLine(e.Message);
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetGiroId");
            }
            finally
            {
                conn.Close();
        ...
        public int GetColonia(string colonia)
        {
            ...
            {
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetColonia");
            }
            finally { conn.Close(); }
            return -1;
        }
        ...
        public List<string> GetSucursales()
        {
            ...
            {
                Console.WriteLine(e.Message);
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetSucursales");
            }
            finally
            {
                conn.Close();
        ...
        public List<MembresiaModel> GetMembresias()
        {
            ...
            {
                Console.WriteLine(e.Message);
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetMembresias");
            }
            finally
            {
                conn.Close();
        ...
        public List<MembresiaModel> GetMembresiasPrecios(Dictionary<string, int> dictMembresias)
        {
            ...
            {
                Console.WriteLine(e.Message);
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetMembresiasPrecios");
            }
            finally
            {
                conn.Close();
        ...
        public List<ProductoModel> GetProductos()
        {
            ...
            {
                Console.WriteLine(e.Message);
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetProductos");
            }
            finally
            {
                conn.Close();
        ...
        public List<ProductoModel> GetProductosPrecios(Dictionary<string, int> dictProductos)
        {
            ...
            {
                Console.WriteLine(e.Message);
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetProductosPrecios");
            }
            finally
            {
                conn.Close();
        ...
        public List<string> GetCodigosPostales()
        {
            ...
            {
                SlackLogs.SendMessage(e.Message, GetType().Name, "GetCodigosPostales");
            }
            finally { conn.Close(); }
            return CPs;
        }
