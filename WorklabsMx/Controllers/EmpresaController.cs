            ...
            try
            {
                ...
                while (reader.Read())
                {
                    empresa = new EmpresaModel
                    {
                        ...
                        Empresa_Red_Social_3 = reader["Empresa_Miembro_Red_Social_3"].ToString(),
                        Empresa_Red_Social_2 = reader["Empresa_Miembro_Red_Social_2"].ToString(),
                        Empresa_Red_Social_1 = reader["Empresa_Miembro_Red_Social_1"].ToString(),
                        Empresa_Pagina_Web = reader["Empresa_Miembro_Pagina_Web"].ToString(),
                        Empresa_Telefono = reader["Empresa_Miembro_Telefono"].ToString(),
                        Empresa_Correo_Electronico = reader["Empresa_Miembro_Correo_Electronico"].ToString(),
                        Empresa_Numero_Interior = reader["Empresa_Miembro_Numero_Interior"].ToString(),
                        Empresa_Numero_Exterior = reader["Empresa_Miembro_Numero_Exterior"].ToString(),
                        Empresa_Calle = reader["Empresa_Miembro_Calle"].ToString(),
                        Empresa_Nombre = reader["Empresa_Miembro_Nombre"].ToString(),
                        Empresa_Rfc = reader["Empresa_Miembro_Rfc"].ToString(),
                        Empresa_Razon_Social = reader["Empresa_Miembro_Razon_Social"].ToString(),
                        Empresa_Logotipo = reader["Empresa_Miembro_Logotipo"].ToString(),
                        Empresa_Id = reader["Empresa_Miembro_Id"].ToString(),
